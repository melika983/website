          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-3 col-md-4" data-aos="fade-up" data-aos-delay="100">
              <div class="features-item">
                 <center>
                <dotlottie-player src="https://lottie.host/344276ab-6cd2-4a97-a0d0-8a3a766aca63/ieFpMR7xvt.json" background="transparent" speed="0.5" style="width: 300px; height: 300px;"  autoplay></dotlottie-player>
                </center>
              </div>
    ...
    <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <a  href="{{ route('scan') }}" class="btn btn-primary" style="font-family: 'Kahroba', sans-serif;">شروع کن</a>
                 <br>
            <div class="d-flex">
              <a  href="{{ route('page4') }}" class="btn btn-outline-primary" style="font-family: 'Kahroba', sans-serif;">صفحه بعد</a>
